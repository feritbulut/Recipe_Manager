namespace RecipeManager
{
    ...
    {
        public static readonly Color Primary = "#6F4F3C".ToColor();
        public static readonly Color Secondary = "#e68a00".ToColor();
        public static readonly Color Tertiary = "#ffa31a".ToColor();
